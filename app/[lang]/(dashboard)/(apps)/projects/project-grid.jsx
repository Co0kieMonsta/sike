...
const ProjectGrid = ({ project, onEdit, onDelete }) => {
      ...
      <Card>
        <CardHeader className="flex-row items-center gap-3 border-none mb-0">
          <div className="flex-1">
            ...
            >
              {project?.status === "inprogress" ? "In Progress" : project?.status === "todo" ? "To Do" : project?.status}
            </Badge>
          </div>
        ...
        <CardFooter className="flex justify-between border-t  p-4">
          <div>
            ...
            <span className="text-xs font-medium text-default-900">
              {project?.assignDate ? formatDate(project?.assignDate) : "-"}
            </span>
          </div>
          <div>
